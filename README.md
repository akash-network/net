...
| -------------------------- | ------------------ | --------------------- | ------------------------------------------------------ |
| [mainnet](mainnet)         | :heavy_check_mark: | v0.28.2     (0.28.0)  | Akash Network mainnet network.                         |
| [sandbox](sandbox)         | :heavy_check_mark: | v0.28.2     (0.28.0)  | Akash Network sandbox playground network.              |
