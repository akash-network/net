...
| -------------------------- | ------------------ | -------------------------------- | ------------------------------------------------------ |
| [mainnet](mainnet)         | :heavy_check_mark: | v0.36.0 (0.36.0)                 | Akash Network mainnet network.                         |
| [sandbox](sandbox)         | :heavy_check_mark: | v0.34.0 (0.34.1)                 | Akash Network sandbox playground network.              |
